...
namespace Presentation
{
    public partial class FormPrincipal : Form
    {
        ...
        Since the form is resized because it takes into
        account the size of the title bar and borders.*/
        //Constructor
        ...
        private void AdjustForm() //Ajusta el formulario al tamaño de la pantalla
        {
