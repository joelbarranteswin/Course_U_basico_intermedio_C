...
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,2,2,23), 
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,3,3,4), 
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,1,4,23), 
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,2,5,52), 
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,3,6,52),
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,1,1,4),
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,2,2,23), 
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,3,3,4), 
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,1,4,23), 
('factura','6656565',CAST(19-08-2012 AS DATETIME) ,2,5,52), 
...
('entas', '12343456', '98734234', 'Rosales AV'),
('Congreso', '12343789', '98734234', 'Rosales normandia'),
('Mercado', '12378956', '98764534', 'Rosales Quiñon'),
('Girando', '17893456', '98761256', 'Rosales Vuelo'),
('Viajes', '78943456', '98756234', 'Rosales Vieto'),
('Ventas', '12789456', '92361234', 'Rosales Azon')
